...
<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=0cb61afbd24641fde802722209dd33df"></script>
...
<body>
	<div class="map_wrap">
		...
		<div class="custom_zoomcontrol radius_border">
			<span onclick="zoomIn()">
			<img src="http://i1.daumcdn.net/localimg/localimages/07/mapapidoc/ico_plus.png" alt="확대"></span> <span onclick="zoomOut()">
